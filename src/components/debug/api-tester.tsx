...
export function ApiTester() {
  ...
  const testEndpoints = [
    ...
    },
    {
      ...
      url: 'http://localhost:8000/api/local-upload/test',
      method: 'GET'
    },
    {
      name: 'PRS Scores',
      url: `http://localhost:8000/api/prs/scores/user/${userId}`,
      method: 'GET'
    },
    {
      name: 'Genomic Data (Original)',
      url: `http://localhost:8000/api/genomic-data/user/${userId}`,
      method: 'GET'
    },
    {
      name: 'Chatbot Test',
  ...
  const createMockData = async () => {
    // Create PRS data
    await testEndpoint('Create PRS', 'http://localhost:8000/api/prs/scores', {
      method: 'POST',
    ...
    await testEndpoint('Create Recommendations', 'http://localhost:8000/api/recommendations', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        user_id: parseInt(userId),
